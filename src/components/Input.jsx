...
import CircleInfo from "@/assets/icons/duotone/circle-info.svg?react";
import Eye from "@/assets/icons/duotone/eye.svg?react";
import EyeSlash from "@/assets/icons/duotone/eye-slash.svg?react";
import ToggleOn from "@/assets/icons/duotone/toggle-on.svg?react";
import ToggleOff from "@/assets/icons/duotone/toggle-off.svg?react";
      ...
      >
        ...
        {type === "textarea" ? (
          <textarea
            ...
            className={twMerge(
              className,
              "outline-none border border-transparent focus-within:border-accentHighlight p-1"
            )}
            placeholder={props.placeholder ?? label}
            onInvalid={onInvalid}
            onBlur={onBlur}
